...
public class Drawable2d {
    ...
    private static final float FULL_RECTANGLE_MIRROR_COORDS[] = {
            1.0f, -1.0f,    // 0 bottom left
            -1.0f, -1.0f,   // 1 bottom right
            1.0f,  1.0f,    // 2 top left
            -1.0f,  1.0f,   // 3 top right
    ...
    private static final FloatBuffer FULL_RECTANGLE_MIRROR_BUF =
            GlUtil.createFloatBuffer(FULL_RECTANGLE_MIRROR_COORDS);
     ...
     */
    public enum Prefab {
        TRIANGLE, RECTANGLE, FULL_RECTANGLE, FULL_RECTANGLE_MIRRORED
    }
    ...
    public Drawable2d(Prefab shape) {
        switch (shape) {
            ...
            case FULL_RECTANGLE_MIRRORED:
                mVertexArray = FULL_RECTANGLE_MIRROR_BUF;
                mTexCoordArray = FULL_RECTANGLE_TEX_BUF;
                mCoordsPerVertex = 2;
                mVertexStride = mCoordsPerVertex * SIZEOF_FLOAT;
                mVertexCount = FULL_RECTANGLE_COORDS.length / mCoordsPerVertex;
